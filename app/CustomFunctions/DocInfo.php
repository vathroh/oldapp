...
class DocInfo
{
    // public function SaveFile($files, $fileName, $parent_folder_code, $new_folder_name)
    public function SaveFile($tahun, $KodeKegiatan, $files, $fileName, $JenisDokumen, $Kodeksm, $kd_kel, $kd_kab, $new_folder_name, $parent_folder_code, $tipedokumen, $titik)
    {
