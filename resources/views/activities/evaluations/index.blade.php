...
<div class="card">
	<div class="card-header card-header-primary">
		<h4 class="card-title ">{{ $activities->where('id', $subject->activity_id)->pluck('name')->first() }}</h4>		
	</div>
	@include('activities.navbar')
	<div class="card-body">
		<form method="post" action="/training-evaluation/{{ $subject->activity_id }}/{{ $subject->id }}" enctype="multipart/form-data">
		@csrf
			<div class="form-group row mt-5">
				...
				<div class="col-md-10">
					<input id="activity" type="text" class="form-control" name="activity" value="{{ $subject->name }}" readonly style="border:none;">
				</div>
			</div>
			<div class="form-group row">
				...
				<div class="col-md-10">
					<input id="subject" type="text" class="form-control" name="subject" value="{{ $subject->subject }}" readonly style="border:none;">
				</div>
			</div>			
