...
<form method="post" action="{{ route('evaluation-questions.store') }}" enctype="multipart/form-data">
    @csrf
    <div class="card">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-10">
                <div class="formcheck form-check-inline">
					<input class="form-check-input" type="radio" name="for_all_subjects" id="inlineRadio1" value="1">
					<label class="form-check-label" for="inlineRadio1">Untuk semua materi</label>
				</div>
				<div class="formcheck form-check-inline">
					<input class="form-check-input" type="radio" name="for_all_subjects" id="inlineRadio2" value="0">
