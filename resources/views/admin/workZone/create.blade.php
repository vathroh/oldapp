                ...
                <div class="row">
                    ...
                    <div class="col-10">
                        <select id="level" name="level" class="form-select">
                            <option selected>Tingkat wilayah Kerja</option>
                            <option value="OSP">OSP</option>
                            <option value="Korkot">Korkot</option>
                            <option value="Askot Mandiri">Askot Mandiri</option>
                            <option value="Tim Faskel">Tim Faskel</option>
