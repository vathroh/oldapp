                            ...
                            <div class="col">
                                <form method="post" action="/doc" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="jenisDokumen" id="jenisDokumen" class="form-control input-lg dynamic">
                                    ...
                                    <div class="text-center">
                                        <button type="button" class="btn btn-primary mt-5">Batal</button>
                            ...
                            <div class="col">
                                <form method="post" action="/ksm" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="ksm_kabupaten" id="ksm_kabupaten" class="form-control input-lg dynamic">
                                            <option value=""></option>
                                            @foreach($kabupaten as $kab)
                                            <option value="{{$kab->kode_kab}}">{{$kab->nama_kab}}</option>
                                            @endforeach
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="ksm_kelurahan" id="ksm_kelurahan" class="form-control input-lg dynamic">
                                            <option value="0"></option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select name="ksm_ksm" id="ksm_ksm" class="form-control input-lg dynamic">
                                            <option value="0"></option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select name="jenisDokumen_ksm" id="jenisDokumen_ksm" class="form-control input-lg dynamic">
                                            <option value=""></option>
                                    ...
                                    <div class="custom-file my-3">
                                        <input type="file" class="form-control" id="file_ksm" name="file_ksm">
                                    </div>
                                    <div class="text-center">
                                        <button type="button" class="btn btn-primary mt-5">Batal</button>
                                        <button type="submit" class="btn btn-primary mt-5">Upload</button>
                            ...
                            <div class="col">
                                <form method="post" action="/foto" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="jenisDokumenFoto" id="jenisDokumenFoto" class="form-control input-lg dynamic">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="foto_kabupaten" id="foto_kabupaten" class="form-control input-lg dynamic">
                                            <option value=""></option>
                                            @foreach($kabupaten as $kab)
                                            <option value="{{$kab->kode_kab}}">{{$kab->nama_kab}}</option>
                                            @endforeach
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="foto_kelurahan" id="foto_kelurahan" class="form-control input-lg dynamic">
                                            <option value="0"></option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="foto_ksm" id="foto_ksm" class="form-control input-lg dynamic">
                                            <option value="0"></option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="row" id="lokasirtdantitik">
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <select name="foto_kegiatan" id="foto_kegiatan" class="form-control input-lg dynamic">
                                                    <option value="0"></option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="TitikFoto" id="TitikFoto" class="form-control input-lg dynamic">
