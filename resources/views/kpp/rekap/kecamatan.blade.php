  ...
  <div class="card-body">
	<nav aria-label="breadcrumb">
	  <ol class="breadcrumb">
		...
		<li class="breadcrumb-item active" aria-current="page">{{ $kppdatas->pluck('NAMA_KAB')->first() }}</li>
	  </ol>
	</nav>
        ...
        <tbody>
          @foreach($kppdatas as $kppdata)
            <tr>
                ...
                <th><a href = "/kpp-rekap-data-kelurahan/{{$kppdata->KD_KEC}}">{{ $kppdata->NAMA_KAB }}</a></th>
